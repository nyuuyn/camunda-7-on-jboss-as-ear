...
Full architecture documentation for this project, following the
[arc42](https://arc42.org) template. The top-level [README](../../README.md)
is a quickstart; this is where the *why* lives.
